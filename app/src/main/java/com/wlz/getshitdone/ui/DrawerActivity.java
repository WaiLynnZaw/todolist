...
public class DrawerActivity extends MaterialNavigationDrawer{
    ...
    public void init(Bundle bundle) {
        ...
        this.addSection(newSection("TODO List",R.drawable.ic_action_done,new MyNotebooks()));
        this.addSection(newSection("My Vitamins",R.drawable.ic_action_format_quote,new MyNotebooks()));
        this.addSection(newSection("My Money Tracker",R.drawable.ic_action_account_balance_wallet,new MyNotebooks()));
